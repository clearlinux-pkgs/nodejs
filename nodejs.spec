...
%prep
%setup -q -n node-v16.19.0
cd %{_builddir}/node-v16.19.0
%patch1 -p1
pushd ..
cp -a node-v16.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670973560
...
cp %{_builddir}/node-v%{version}/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/d735ed944e7c036b5807b02ae3a155a44586b0ad || :
...
/usr/share/package-licenses/nodejs/d735ed944e7c036b5807b02ae3a155a44586b0ad
