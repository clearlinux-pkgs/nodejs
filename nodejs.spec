...
%prep
%setup -q -n node-v22.5.1
cd %{_builddir}/node-v22.5.1
%patch -P 1 -p1
pushd ..
cp -a node-v22.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1722356242
...
cp %{_builddir}/node-v%{version}/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/e7792c9987420de79d074d8ac756b3605047d0e5 || :
...
cp %{_builddir}/node-v%{version}/deps/nbytes/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/ac0b6a455724824460d489e155cc4a87ad22f6ca || :
...
/usr/share/package-licenses/nodejs/ac0b6a455724824460d489e155cc4a87ad22f6ca
...
/usr/share/package-licenses/nodejs/e7792c9987420de79d074d8ac756b3605047d0e5
