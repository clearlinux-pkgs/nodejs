...
Source0  : https://nodejs.org/dist/v20.14.0/node-v20.14.0.tar.gz
...
%prep
%setup -q -n node-v20.14.0
cd %{_builddir}/node-v20.14.0
%patch -P 1 -p1
pushd ..
cp -a node-v20.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717179885
