...
Version  : 16.17.1
Release  : 135
URL      : https://nodejs.org/dist/v16.17.1/node-v16.17.1.tar.gz
Source0  : https://nodejs.org/dist/v16.17.1/node-v16.17.1.tar.gz
Summary  : unknown
...
%prep
%setup -q -n node-v16.17.1
cd %{_builddir}/node-v16.17.1
%patch1 -p1
pushd ..
cp -a node-v16.17.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664213020
...
cp %{_builddir}/node-v%{version}/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/f3a798f86777576915ef1394eadd17e43f8f23d4 || :
...
cp %{_builddir}/node-v%{version}/deps/acorn/acorn/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/42388860aa6d9bdaf299d53fa25a9e628101617e || :
...
cp %{_builddir}/node-v%{version}/deps/icu-small/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/255667e4213ddb7198295c9775079c093a046f42 || :
...
cp %{_builddir}/node-v%{version}/deps/npm/node_modules/glob/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/79166a654db8904907e23bb644d32e1f1ff4554e || :
...
cp %{_builddir}/node-v%{version}/deps/openssl/openssl/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/607e96d7bc75d9f884a8e210d276cca4006e0753 || :
cp %{_builddir}/node-v%{version}/deps/openssl/openssl/external/perl/Text-Template-1.46/COPYING %{buildroot}/usr/share/package-licenses/nodejs/ab8577d3eb0eedf3f98004e381a9cee30e7224e1 || :
...
cp %{_builddir}/node-v%{version}/deps/uv/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/848f7398f89046426a7ba23cb56cd3c93c030c64 || :
...
cp %{_builddir}/node-v%{version}/deps/v8/third_party/jinja2/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/1c067319f47a331224f855e8c0b9a7735f9885c6 || :
...
cp %{_builddir}/node-v%{version}/deps/zlib/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/0f7174a2c02ad5a6951dcdca4a8c9acda981aa2e || :
...
/usr/share/package-licenses/nodejs/255667e4213ddb7198295c9775079c093a046f42
...
/usr/share/package-licenses/nodejs/f3a798f86777576915ef1394eadd17e43f8f23d4
