...
Version  : 16.18.0
Release  : 136
URL      : https://nodejs.org/dist/v16.18.0/node-v16.18.0.tar.gz
Source0  : https://nodejs.org/dist/v16.18.0/node-v16.18.0.tar.gz
Summary  : unknown
...
%prep
%setup -q -n node-v16.18.0
cd %{_builddir}/node-v16.18.0
%patch1 -p1
pushd ..
cp -a node-v16.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666029020
