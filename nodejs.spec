...
Source0  : https://nodejs.org/dist/v16.18.1/node-v16.18.1.tar.xz
Summary  : unknown
...
%prep
%setup -q -n node-v16.18.1
cd %{_builddir}/node-v16.18.1
%patch1 -p1
%patch2 -p1
pushd ..
cp -a node-v16.18.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667871983
...
cp %{_builddir}/node-v%{version}/LICENSE %{buildroot}/usr/share/package-licenses/nodejs/b4478468e0f55ebe49798cb562cac68e1a9b06b6 || :
...
/usr/share/package-licenses/nodejs/b4478468e0f55ebe49798cb562cac68e1a9b06b6
